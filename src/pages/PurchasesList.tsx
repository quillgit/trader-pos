    ...
    return (
        <div className="space-y-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <Link to="/purchases/new" className="bg-blue-600 text-white px-3 py-2 rounded-md flex items-center gap-2 text-sm w-full sm:w-auto justify-center">
            ...
            <div className="bg-white border rounded-md overflow-hidden">
                {paginatedPurchases.length === 0 ? (
                    <div className="p-8 text-center text-gray-500">No purchases found matching criteria.</div>
                ) : (
                    <>
